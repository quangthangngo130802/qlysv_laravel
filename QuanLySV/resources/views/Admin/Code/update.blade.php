            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a>Update Information</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                ...
                                <form class="form-valide"
                                    action="{{ route('admin.updateCode.submit', ['code_id' => $data->code_id]) }}"
                                    method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-1">
                                        ...
                                        <div class="col-xl-10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control"
                                                        name="time" value="{{ $data->time }}" required>
                                                    @if ($errors->has('time'))
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control"
                                                        name="semester" value="{{ $data->semester }}" required>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control"
                                                        name="year" value="{{ $data->year }}" required>
                                                    @if ($errors->has('year'))
                                                        <p class="error-message">
                                                            {{ $errors->first('year') }}</p>
                                                    @endif
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="on_off" {{ $data->on_off == 1?'checked':'' }}>
