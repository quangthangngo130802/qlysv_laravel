            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a>Posts Search List</a></li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="card-header card-margin">
                            <div>
                                @hasRole(['Admin', 'Editor'])
                                    <a href="{{ route('admin.addPosts.form') }}"><Span class="btn btn-primary">
                                            <i class="fa-solid fa-user-plus"></i> Add Posts</Span></a>

                                    <a style="display: none" id="delete-posts-btn"><Span class="btn btn-primary">
                                            ...
                                            <tbody>
                                                @foreach ($posts as $item)
                                                    @php
                                                        $i++;
                                                    @endphp
                                                    <tr id="postsValue-{{ $item->posts_id }}"
                                                        class="green-hover
                                                    @if ($i % 2 == 0) tr-background @endif ">
                                                        <td><input class="posts-checked" type="checkbox"
                                                                name="postsChecked[]" value="{{ $item->posts_id }}">
                                                        </td>
