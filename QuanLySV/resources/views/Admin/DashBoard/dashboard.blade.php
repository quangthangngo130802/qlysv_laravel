                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <div class="stat-digit"><i class="fa-solid fa-plus"></i>{{ $totalStudent }}</div>
                                </div>
                                <div class="progress">
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <div class="stat-digit"><i class="fa-solid fa-plus"></i>{{ $totalTeacher }}</div>
                                </div>
                                <div class="progress">
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <div class="stat-digit"><i class="fa-solid fa-plus"></i>{{ $totalFaculty }}</div>
                                </div>
                                <div class="progress">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Total Major</div>
                                    <div class="stat-digit"><i class="fa-solid fa-plus"></i>{{ $totalMajor }}</div>
                                </div>
                                <div class="progress">
