            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a>Update Subject</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                ...
                                <form class="form-valide"
                                    action="{{ route('admin.updateSubject.submit', ['subject_id' => $subject->subject_id]) }}"
                                    method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-2">
                                                    ...
                                                    <select class="form-control" id="val-skill" name="major_id">
                                                        ...
                                                        @foreach ($major as $item)
                                                            <option value="{{ $item->major_id }}"
                                                                {{ $subject->major_id == $item->major_id ? 'selected' : '' }}>
                                                                {{ $item->major_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
