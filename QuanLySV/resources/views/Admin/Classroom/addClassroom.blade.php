            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a>Add Classroom</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-validation">
                                ...
                                <form class="form-valide" action="{{ route('admin.addClassroom.submit') }}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-2">
                                        </div>
                                        <div class="col-xl-8">
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label" for="val-username"> Building Name
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label" for="val-username">Room Name
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control" name="room_name">
                                                    @if ($errors->has('room_name'))
                                                        <p class="error-message">{{ $errors->first('room_name') }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    @if ($errors->has('capacity'))
                                                        <p class="error-message">{{ $errors->first('capacity') }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="form-group row">
