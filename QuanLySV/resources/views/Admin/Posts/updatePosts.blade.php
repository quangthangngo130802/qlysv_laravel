            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a>Update Posts</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                ...
                                <form class="form-valide"
                                    action="{{ route('admin.updatePosts.submit', ['posts_id' => $posts->posts_id]) }}"
                                    method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-1">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <textarea id="ckeditor1" class="form-control valid" id="val-suggestions" name="posts_content" rows="5"
                                                        aria-describedby="val-suggestions-error" aria-invalid="false">{{ $posts->posts_content }}</textarea>
